...
'The chance, dice, and rangepick functions do not inheritly RANDOMIZE
'  themselves, you are responsible for calling RANDOMIZE, but it does not
'  necessarily need to be called every time you call these functions.
'
'******************************************************************************
'
